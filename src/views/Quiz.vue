<template>
    <div>
        ...
        <v-container width="800px" class="flip-card">
            <v-card class="mt-6 pa-6 d-flex align-center justify-center text-center flip-card-inner" :class="{ flipped: showAnswer }"
                height="400px" width="800px" style="margin-left: auto; margin-right: auto;">
                <transition name="fade">
                    <div class="flip-card-front" v-show="!showAnswer">

                        <p class="text-h6">{{ currentCard.question }}</p>

                        <v-btn @click="flipCard" class="mt-4" color="grey" variant="text">
                            Flip
                        </v-btn>
            ...
            <div class="d-flex justify-space-between mt-6" style="width:800px">
                ...
                <v-btn @click="nextCard" :disabled="currentCardIndex === cards.length - 1"
