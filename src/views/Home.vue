      ...
      <v-col cols="12" md="6">
        <div class="d-flex justify-center align-center ga-2">
          ...
          <v-tooltip location="top" max-width="320">
            ...
            <span>
              Cut along the dotted lines. A paper trimmer works best, or use a ruler + craft knife
              for clean edges.
            </span>
          </v-tooltip>
        </div>
        ...
        <div class="column-content my-auto">
          ...
          <v-card :width="get_previewWidth()" :height="get_previewHeight()" class="cardPreview border">
            ...
            <v-row>
              <p class="reference" id="reference" :style="{ fontFamily: this.selectedFont.value }">
                2 Corinthians 5:17
              </p>
            </v-row>
